        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          <div className="md:col-span-2 lg:col-span-1">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <p className="text-lg font-semibold">Sienna Ridge Homes</p>
          ...
          <div>
            <FooterAccordionSection title="Contact Information" defaultOpen>
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href={`mailto:${NAP.email}`} className="text-gray-300 hover:text-blue-400 transition-colors break-all">
                    {NAP.email}
                  </a>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <address className="text-gray-300 not-italic">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-block mt-2 text-sm text-blue-300 hover:text-blue-400 transition-colors"
                    >
                      Get Directions
                    </a>
                  </address>
          ...
          <div>
            <FooterAccordionSection title="Guides & FAQ">
              <FooterLinkList>
                <li>
          ...
          <div>
            <FooterAccordionSection title="Homes & Guides">
              <FooterLinkList>
                <li>
          ...
          <div>
            <FooterAccordionSection title="Service Areas">
